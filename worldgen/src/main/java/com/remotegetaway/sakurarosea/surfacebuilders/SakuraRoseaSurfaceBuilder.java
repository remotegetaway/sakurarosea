 ...
 * to modify.
 */
public abstract class SakuraRoseaSurfaceBuilder {
	 ...
	 */
	public SakuraRoseaSurfaceBuilder setBiomeKey(RegistryKey<Biome> biomeKey) {
	 ...
	 * @return TerrestriaSurfaceBuilder - This method returns the surface builder being configured.
	 */
	public SakuraRoseaSurfaceBuilder setBiomeTag(TagKey<Biome> biomeTag) {
