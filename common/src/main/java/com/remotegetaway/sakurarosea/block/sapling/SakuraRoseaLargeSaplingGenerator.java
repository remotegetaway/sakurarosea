...
public class SakuraRoseaLargeSaplingGenerator extends LargeTreeSaplingGenerator {
	public final Supplier<RegistryKey<ConfiguredFeature<?, ?>>> tree;
	public final Supplier<RegistryKey<ConfiguredFeature<?, ?>>> largeTree;

	public SakuraRoseaLargeSaplingGenerator(Supplier<RegistryKey<ConfiguredFeature<?, ?>>> tree, Supplier<RegistryKey<ConfiguredFeature<?, ?>>> largeTree) {
		this.tree = tree;
