...
public class SakuraRoseaBiomeTagProvider extends FabricTagProvider<Biome> {
	protected SakuraRoseaBiomeTagProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
