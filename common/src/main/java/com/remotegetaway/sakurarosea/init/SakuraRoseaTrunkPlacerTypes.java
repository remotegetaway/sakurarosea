...
import com.remotegetaway.sakurarosea.feature.tree.trunkplacers.*;
import net.minecraft.util.Identifier;
import net.minecraft.world.gen.trunk.TrunkPlacer;
import net.minecraft.world.gen.trunk.TrunkPlacerType;

public class SakuraRoseaTrunkPlacerTypes {
	...
	private static <P extends TrunkPlacer> TrunkPlacerType<P> register(String name, Codec<P> codec) {
		return PlacerTypes.registerTrunkPlacer(new Identifier(SakuraRosea.MOD_ID, name), codec);
	}
