...
public class StoneItems {
	...
	public static StoneItems register(String name, StoneBlocks blocks) {
		...
		items.button = SakuraRoseaRegistry.registerBlockItem(name + "_button", blocks.button);
		items.pressurePlate = SakuraRoseaRegistry.registerBlockItem(name + "_pressure_plate", blocks.pressurePlate);
		items.chiseledBricks = SakuraRoseaRegistry.registerBlockItem("chiseled_" + name + "_bricks", blocks.chiseledBricks);
		items.crackedBricks = SakuraRoseaRegistry.registerBlockItem("cracked_" + name + "_bricks", blocks.crackedBricks);
